...
public class Tetrimino4 implements Shape {
    ...
    public Tetrimino4() {
        this.nTiles = 4;
        this.fillColor = new Color(128, 0, 128);
        this.borderColor = new Color(255, 0, 255);
        this.currentRotationIndex = 0;
        this.rotation = new Point2D[Tetrimino4.N_ROTATIONS][this.nTiles];
    ...
    public void rotateRigth() {
        this.currentRotationIndex = (this.currentRotationIndex + 1) % Tetrimino4.N_ROTATIONS;
    }

    public void rotateLeft() {
        this.currentRotationIndex = (Tetrimino4.N_ROTATIONS + this.currentRotationIndex - 1) % Tetrimino4.N_ROTATIONS;
    }

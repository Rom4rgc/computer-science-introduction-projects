...
public class Tetrimino6 implements Shape {
    ...
    public Tetrimino6() {
        ...
        this.borderColor = new Color(255, 102, 102);
        this.currentRotationIndex = 0;
        this.rotation = new Point2D[Tetrimino6.N_ROTATIONS][this.nTiles];
    ...
    public void rotateRigth() {
        this.currentRotationIndex = (this.currentRotationIndex + 1) % Tetrimino6.N_ROTATIONS;
    }

    public void rotateLeft() {
        this.currentRotationIndex = (Tetrimino6.N_ROTATIONS + this.currentRotationIndex - 1) % Tetrimino6.N_ROTATIONS;
    }

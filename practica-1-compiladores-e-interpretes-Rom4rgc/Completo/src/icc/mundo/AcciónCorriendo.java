...
/**
 * El personaje corre hacia la derecha, desplazándose horizontalmente.
 */
class AcciónCorriendo extends Acción {
	 ...
	 */
	AcciónCorriendo(String nombre) throws IOException {
		super(Estado.Corriendo, nombre, new Point(Personaje.LADO / 4, 0), 6);
	}
